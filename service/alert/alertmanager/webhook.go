...
func alertDetails(alert template.Alert) string {
	...
	// labels dump
	builder.WriteString("<h3>Labels</h3>\n<ul>\n")
	...
	// annotations dump
	builder.WriteString("<h3>Annotations</h3>\n<ul>\n")
