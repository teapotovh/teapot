...
const (
	ResultCodeSuccess                      ENUMERATED = 0
	ResultCodeOperationsError              ENUMERATED = 1
	ResultCodeProtocolError                ENUMERATED = 2
	ResultCodeTimeLimitExceeded            ENUMERATED = 3
	ResultCodeSizeLimitExceeded            ENUMERATED = 4
	ResultCodeCompareFalse                 ENUMERATED = 5
	ResultCodeCompareTrue                  ENUMERATED = 6
	ResultCodeAuthMethodNotSupported       ENUMERATED = 7
	ResultCodeStrongerAuthRequired         ENUMERATED = 8
	ResultCodeReferral                     ENUMERATED = 10
	ResultCodeAdminLimitExceeded           ENUMERATED = 11
	ResultCodeUnavailableCriticalExtension ENUMERATED = 12
	ResultCodeConfidentialityRequired      ENUMERATED = 13
	ResultCodeSaslBindInProgress           ENUMERATED = 14
	ResultCodeNoSuchAttribute              ENUMERATED = 16
	ResultCodeUndefinedAttributeType       ENUMERATED = 17
	ResultCodeInappropriateMatching        ENUMERATED = 18
	ResultCodeConstraintViolation          ENUMERATED = 19
	ResultCodeAttributeOrValueExists       ENUMERATED = 20
	ResultCodeInvalidAttributeSyntax       ENUMERATED = 21
	ResultCodeNoSuchObject                 ENUMERATED = 32
	ResultCodeAliasProblem                 ENUMERATED = 33
	ResultCodeInvalidDNSyntax              ENUMERATED = 34
	ResultCodeAliasDereferencingProblem    ENUMERATED = 36
	ResultCodeInappropriateAuthentication  ENUMERATED = 48
	ResultCodeInvalidCredentials           ENUMERATED = 49
	ResultCodeInsufficientAccessRights     ENUMERATED = 50
	ResultCodeBusy                         ENUMERATED = 51
	ResultCodeUnavailable                  ENUMERATED = 52
	ResultCodeUnwillingToPerform           ENUMERATED = 53
	ResultCodeLoopDetect                   ENUMERATED = 54
	ResultCodeNamingViolation              ENUMERATED = 64
	ResultCodeObjectClassViolation         ENUMERATED = 65
	ResultCodeNotAllowedOnNonLeaf          ENUMERATED = 66
	ResultCodeNotAllowedOnRDN              ENUMERATED = 67
	ResultCodeEntryAlreadyExists           ENUMERATED = 68
	ResultCodeObjectClassModsProhibited    ENUMERATED = 69
	ResultCodeAffectsMultipleDSAs          ENUMERATED = 71
	ResultCodeOther                        ENUMERATED = 80
)
