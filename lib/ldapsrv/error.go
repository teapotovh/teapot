...
var (
	...
	ErrUnavailableCriticalExtension = withCode(
		ldap.ResultCodeUnavailableCriticalExtension,
	...
	ErrInappropriateAuthentication = withCode(
		ldap.ResultCodeInappropriateAuthentication,
...
func withCode(code ldap.ENUMERATED, message string) error {
	return codeError{code: code, error: errors.New(message)} //nolint:err113
}
